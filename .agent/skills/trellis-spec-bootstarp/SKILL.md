...
description: "Bootstrap project-specific Trellis coding specs with a platform-neutral single-agent workflow. Use when creating or refreshing .trellis/spec guidelines, analyzing a Godot GDScript codebase with source inspection, decomposing package/layer spec work, and writing real codebase-backed spec docs without placeholder text."
---
...
2. Analyze the repository architecture with `rg`, Godot project metadata, the editor MCP, and direct source reads.
...
| Godot editor validation setup | [references/mcp-setup.md](references/mcp-setup.md) |
