...
| `trellis-spec-bootstrap` | Platform-neutral workflow for creating or refreshing `.trellis/spec/` from the real Godot GDScript codebase using native source inspection and editor validation. |
